        ...
        <thead>
            <tr>
               <th> # </th>
                ...
                <th width="150" style="margin-right:200px;">Adresse</th>
      ...
      <tbody>
        ...
        <tr v-for="(client,index) in clients" :key="client">
            ...
            <td v-if="client.address!==undefined" >
               <input v-if="update" v-model=" client.address.city" class="form-control" style="width:200px;" disabled>  
               <span v-else style="margin-right:200px;">  {{ client.address.city }}  </span>
            </td>
